...
.run(['$templateCache',function($templateCache){
   $templateCache.put("/dialogs/error.html",
   	"<div class=\"modal-header dialog-header-error\"><button type=\"button\" class=\"close\" ng-click=\"close()\">&times;</button><h4 class=\"modal-title text-danger\"><span class=\"glyphicon glyphicon-warning-sign\"></span> <span ng-bind=\"header\"></span></h4></div><div class=\"modal-body text-danger\" ng-bind=\"msg\"></div><div class=\"modal-footer\"><button type=\"button\" class=\"btn btn-default\" style=\"background-color:white;\" ng-click=\"close()\">Close</button></div>");
   $templateCache.put("/dialogs/wait.html",
   	"<div class=\"modal-header dialog-header-wait\"><h4 class=\"modal-title\"><span class=\"glyphicon glyphicon-time\"></span> Please Wait</h4></div><div class=\"modal-body\"><p ng-bind=\"msg\"></p><div class=\"progress progress-striped active\"><div class=\"progress-bar progress-bar-info\" ng-style=\"getProgress()\"></div><span class=\"sr-only\">{{progress}}% Complete</span></div></div>");
   $templateCache.put("/dialogs/notify.html",
   	"<div class=\"modal-header dialog-header-notify\"><button type=\"button\" class=\"close\" ng-click=\"close()\" class=\"pull-right\">&times;</button><h4 class=\"modal-title text-info\"><span class=\"glyphicon glyphicon-info-sign\"></span> {{header}}</h4></div><div class=\"modal-body text-info\" ng-bind=\"msg\"></div><div class=\"modal-footer\"><button type=\"button\" class=\"btn btn-primary\" style=\"background-color:white;\" ng-click=\"close()\">OK</button></div>");
   $templateCache.put("/dialogs/confirm.html",
   	"<div class=\"modal-header dialog-header-confirm\"><button type=\"button\" class=\"close\" ng-click=\"no()\">&times;</button><h4 class=\"modal-title\"><span class=\"glyphicon glyphicon-check\"></span> {{header}}</h4></div><div class=\"modal-body\" style=\"color:black;\" ng-bind=\"msg\"></div><div class=\"modal-footer\"><button type=\"button\" class=\"btn btn-default\" style=\"background-color:white;\" ng-click=\"yes()\">Yes</button><button type=\"button\" class=\"btn btn-primary\" ng-click=\"no()\">No</button></div>");
}]);
